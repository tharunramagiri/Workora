...
// Workora therefore repeats a compatibility instruction envelope on every one-shot turn. Project
...
// handleKimiEvent maps one parsed `kimi -p --output-format stream-json` line to Workora callbacks.
