...
export interface StartOpts {
  ...
  stateDir: string;                // Workora-owned durable memory/runtime artifacts; safe to reset
  model?: string;
  ...
  env: NodeJS.ProcessEnv;          // includes PATH injection for Workora + OPEN_WORKORA_* env vars
