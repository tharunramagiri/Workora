...
// (daemon/prompt.ts) drives it to run `Workora message check`, which pulls every unread (seq > lastReadSeq)
...
const COOLDOWN_MS = Number(process.env.OPEN_WORKORA_CATCHUP_COOLDOWN_MS ?? 30_000);
