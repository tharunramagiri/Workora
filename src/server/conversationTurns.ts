...
const TURN_WINDOW_MS = parseConversationTurnWindowMs(process.env.OPEN_WORKORA_TURN_DEBOUNCE_MS);
const DIRECT_TURN_WINDOW_MS = parseConversationTurnWindowMs(process.env.OPEN_WORKORA_DIRECT_TURN_DEBOUNCE_MS, 800);
const TURN_MAX_WAIT_MS = parseConversationTurnWindowMs(process.env.OPEN_WORKORA_TURN_MAX_WAIT_MS, DEFAULT_CONVERSATION_TURN_MAX_WAIT_MS);
