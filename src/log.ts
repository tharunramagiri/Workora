// Unified structured logging: JSON lines written to ~/.Workora/logs/<component>.log plus human-readable console output.
// To tail logs: tail -f ~/.Workora/logs/server.log  (or daemon/cli/agent-<id>)
...
const MIN = order[(process.env.OPEN_WORKORA_LOG_LEVEL as Level) ?? "debug"] ?? 10;
